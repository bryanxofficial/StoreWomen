...
// Fetch watches that are on promotion from the database
$sql = "SELECT * FROM watches WHERE on_promotion = 1";
...
?>
    ...
    <head>
        ...
        <title>Women's Watch Store - Promotions</title>
        <link rel="stylesheet" href="styles.css">
    </head>
    <body>
    <header>
        <h1>Current Watch Promotions</h1>
        <nav>
